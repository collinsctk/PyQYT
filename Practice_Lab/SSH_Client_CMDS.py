...
if __name__ == '__main__':
	QYT_SSHClient_MultiCMD('202.100.1.1', 'admin', 'cisco', ['configure terminal', 'ip access-list extended python_acl_9728', 'deny ip host 202.100.1.5 any', 'deny ip host 202.100.1.5 any', 'deny ip host 202.100.1.254 any', 'permit ip any any', 'interface FastEthernet2/0', 'ip access-group python_acl_9728 in'])